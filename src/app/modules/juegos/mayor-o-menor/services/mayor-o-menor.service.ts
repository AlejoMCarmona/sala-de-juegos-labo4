...
import { CardResponse } from '../interfaces/cards.interface';
...
export class MayorOMenorService {
  // private urlApi: string = "https://www.deckofcardsapi.com/api/deck/new/draw/?";

  constructor(private _httpClient: HttpClient) { }

  // async obtenerMazoDeCartas(cantidadCartas: number): Promise<CardResponse> {
  //   const respuesta = await firstValueFrom(this._httpClient.get<CardResponse>(this.urlApi + "count=" + cantidadCartas));
  //   return respuesta;
  // }

  async obtenerMazoDeCartasSimulado(cantidadCartas: number): Promise<CardResponse> {
    const data = 
    {
      "success": true,
      "deck_id": "",
